    ...
    const articles = [
        {
            ...
            excerpt: "The native method for replying to a comment with a video on TikTok, plus the mockup workflow for building custom comment overlays for UGC ad creatives.",
            date: 'Feb 19, 2026',
            ts: 20260219,
            readTime: '5 min read',
            category: 'Tutorial',
        ...
        },
        {
            ...
            excerpt: "Looking for the best TokComment alternative? A complete comparison of the top free tools for building comment mockup overlays.",
            date: 'Feb 19, 2026',
            ts: 20260219,
            readTime: '6 min read',
            category: 'Comparison',
        ...
        },
        {
            ...
            title: 'TikTok Comment Mockup Generator for UGC Ads (2026)',
            excerpt: "Build pixel-perfect TikTok comment mockup overlays as transparent PNGs for UGC ad creatives and content demos — no watermark, instant download.",
            date: 'Mar 2, 2026',
            ts: 20260302,
            readTime: '7 min read',
            category: 'Tool Guide',
