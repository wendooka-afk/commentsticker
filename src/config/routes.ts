...
export const PAGE_SCHEMAS: Partial<Record<Page, object>> = {
  ...
  'guide-comparison': {
    ...
    author: { '@type': 'Person', name: 'Oumarou Sanda', url: 'https://commentsticker.com/about/' },
    publisher: { '@type': 'Organization', name: 'CommentSticker', url: 'https://commentsticker.com/' },
  },
  about: {
    '@context': 'https://schema.org',
    '@type': 'AboutPage',
    name: 'About CommentSticker',
    url: 'https://commentsticker.com/about/',
    description: 'About CommentSticker — the free UGC creative toolkit built by Oumarou Sanda.',
    mainEntity: {
      '@type': 'Organization',
      name: 'CommentSticker',
      url: 'https://commentsticker.com/',
      founder: { '@type': 'Person', name: 'Oumarou Sanda' },
      contactPoint: { '@type': 'ContactPoint', contactType: 'customer support', url: 'https://commentsticker.com/contact/' },
    },
  },
  'hashtag-generator': {
    '@context': 'https://schema.org',
